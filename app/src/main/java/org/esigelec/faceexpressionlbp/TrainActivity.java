...
public class TrainActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    public void showLabelsDialog() {
        ...
        if (!uniqueLabelsSet.isEmpty()) {
            ...
            final AlertDialog dialog = builder.create(); // Show dialog and store in final variable, so it can be dismissed by the ListView
            dialog.setButton(AlertDialog.BUTTON_NEUTRAL, "Add New", new DialogInterface.OnClickListener() {
    ...
    public void onCameraViewStarted(int width, int height) {
        ...
        classifier = FileUtils.loadXMLS(this);
    }
